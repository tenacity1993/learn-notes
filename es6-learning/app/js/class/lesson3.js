...
}
{
  ...
  let a1 = /b+/g
  let a2 = /b+/y
  let a4 = /\b(\w+)\b\s+\1\b/ // \1 表示分组1匹配的文本
  let a5 = /\b\w+(?=ing\b)/g
  // let a6 = /(?<=\bre)\w+\b/
  console.log(a4.exec('go go'));
  console.log(a5.exec("I'm singing while you're dancing"));
  console.log(a5.exec("I'm singing while you're dancing"));
  console.log(a5.lastIndex);
  // console.log(a6.exec('reading a book'));
